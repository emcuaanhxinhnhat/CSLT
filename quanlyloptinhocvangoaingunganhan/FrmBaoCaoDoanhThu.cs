...
namespace quanlyloptinhocvangoaingunganhan
{
    public partial class FrmBaoCaoDoanhThu : Form
    {
        ...
        private void Load_dgv()
        {
            DAO.OpenConnection();
            string sql;
            sql = "Select tblLophoc.MaLop,tblLophoc.TenLop,tblMonhoc.MaMon,tblLophoc.SiSo,tblMonhoc.HocPhi,(tblMonhoc.HocPhi * tblLophoc.SiSo) as DoanhThu from tblLophoc  join tblMonhoc  on tblLophoc.MaMon = tblMonhoc.MaMon where tblLophoc.NgayBD between N'" + DAO.ConvertDateTime(dtpTu.Text) + "' and tblLophoc.NgayKT N'" + DAO.ConvertDateTime(dtpDen.Text) + "' group by tblLophoc.MaLop, tblLophoc.TenLop, tblMonhoc.MaMon,tblLophoc.SiSo";
